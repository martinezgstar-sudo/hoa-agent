    ...
    <main style={{fontFamily:"system-ui,sans-serif",backgroundColor:"#f9f9f9",minHeight:"100vh"}}>
      ...
      <div style={{maxWidth:"800px",margin:"0 auto",padding:"48px 32px"}}>
        ...
        <div style={{textAlign:"center",marginBottom:"56px"}}>
          <div style={{fontSize:"11px",fontWeight:"600",color:"#06875e",textTransform:"uppercase",letterSpacing:"0.08em",marginBottom:"12px"}}>HOA Agent Reports</div>
        ...
        <div style={{display:"flex",justifyContent:"space-between",alignItems:"flex-start",marginBottom:"20px"}}>
            <div>
              <div style={{fontSize:"13px",fontWeight:"600",color:"#06875e",marginBottom:"6px",textTransform:"uppercase",letterSpacing:"0.05em"}}>Single community report</div>
              <div style={{fontSize:"32px",fontWeight:"700",color:"#1a1a1a",marginBottom:"4px"}}>$29</div>
              <div style={{fontSize:"13px",color:"#595959"}}>Per community, one-time</div>
            </div>
          ...
          <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:"8px"}}>
            {["Full source trail with citations","Fee history and observed range","STR, pet and rental restrictions","Entity status and registered agent","Special assessment signals","Management company details","Resident review summary","PDF download included"].map(f => (
              <div key={f} style={{display:"flex",alignItems:"center",gap:"8px",fontSize:"13px",color:"#555"}}>
                <span style={{color:"#06875e",fontWeight:"700"}}>✓</span>{f}
              </div>
            ))}
          </div>
        </div>
        ...
        <div style={{marginBottom:"48px"}}>
          <div style={{fontSize:"13px",fontWeight:"600",color:"#595959",textTransform:"uppercase",letterSpacing:"0.05em",marginBottom:"16px"}}>Agent bundles — buy in bulk and save</div>
          <div style={{display:"grid",gridTemplateColumns:"repeat(3,1fr)",gap:"16px"}}>
            {[
              ...
              <div key={t.name} style={{backgroundColor:t.highlight?"#EEF2FF":"#fff",border:"2px solid "+(t.highlight?"#1B2B6B":"#e5e5e5"),borderRadius:"12px",padding:"20px",textAlign:"center"}}>
                <div style={{fontSize:"12px",fontWeight:"600",color:"#595959",marginBottom:"4px"}}>{t.name}</div>
                <div style={{fontSize:"28px",fontWeight:"700",color:"#1a1a1a",marginBottom:"2px"}}>{t.price}</div>
                <div style={{fontSize:"12px",color:"#595959",marginBottom:"6px"}}>{t.qty}</div>
                <div style={{fontSize:"12px",color:"#06875e",fontWeight:"600",marginBottom:"2px"}}>{t.per}</div>
                <div style={{fontSize:"11px",color:"#595959",marginBottom:"16px"}}>{t.savings}</div>
          ...
          <div style={{backgroundColor:"#f9f9f9",borderRadius:"12px",padding:"16px 20px",marginTop:"16px",display:"flex",justifyContent:"space-between",alignItems:"center"}}>
            <div>
              ...
              <div style={{fontSize:"12px",color:"#595959"}}>Active BNI members get 20% off all bundles. Mention your chapter at checkout.</div>
            </div>
        ...
        <div style={{backgroundColor:"#1B2B6B",borderRadius:"16px",padding:"32px",color:"#fff",marginBottom:"48px"}}>
          <div style={{fontSize:"11px",fontWeight:"600",color:"#06875e",textTransform:"uppercase",letterSpacing:"0.08em",marginBottom:"12px"}}>For local businesses</div>
          ...
          <a href="mailto:fieldlogisticsfl@gmail.com" style={{display:"inline-block",padding:"12px 24px",borderRadius:"8px",backgroundColor:"#06875e",color:"#fff",textDecoration:"none",fontSize:"14px",fontWeight:"600"}}>Inquire about sponsorship</a>
        </div>
