      ...
      {open && (
        <div style={{position:"fixed",top:0,left:0,right:0,bottom:0,backgroundColor:"rgba(0,0,0,0.5)",zIndex:1000,display:"flex",alignItems:"center",justifyContent:"center",padding:"24px"}} onClick={() => setOpen(false)}>
          <div style={{backgroundColor:"#fff",borderRadius:"16px",padding:"32px",maxWidth:"440px",width:"100%",position:"relative"}} onClick={e => e.stopPropagation()}>
            <button onClick={() => setOpen(false)} style={{position:"absolute",top:"16px",right:"16px",background:"none",border:"none",fontSize:"20px",cursor:"pointer",color:"#595959"}}>✕</button>
            {submitted ? (
              <div style={{textAlign:"center",padding:"16px 0"}}>
                <div style={{fontSize:"40px",marginBottom:"16px"}}>✓</div>
                <div style={{fontSize:"18px",fontWeight:"600",color:"#1a1a1a",marginBottom:"8px"}}>You are on the list</div>
                <div style={{fontSize:"14px",color:"#595959",lineHeight:"1.6"}}>Full reports are coming soon. We will email you as soon as they are available — along with a discount for early access.</div>
              </div>
            ) : (
              <>
                <div style={{fontSize:"11px",fontWeight:"600",color:"#06875e",textTransform:"uppercase",letterSpacing:"0.08em",marginBottom:"8px"}}>Full HOA Report — </div>
                <h2 style={{fontSize:"22px",fontWeight:"600",color:"#1a1a1a",marginBottom:"8px",lineHeight:"1.3"}}>Get the complete picture</h2>
                <p style={{fontSize:"13px",color:"#595959",lineHeight:"1.7",marginBottom:"20px"}}>Full reports are coming soon. Enter your email to be notified when available — early access customers get a discount.</p>
