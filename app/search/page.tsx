          ...
          <a key={c.id} href={`/community/${c.slug}`} style={{textDecoration:'none'}}>
            <div style={{backgroundColor:'#fff',border:'1px solid #e5e5e5',borderRadius:'12px',padding:'16px 20px',marginBottom:'10px',display:'flex',justifyContent:'space-between',alignItems:'flex-start',cursor:'pointer'}}>
              <div>
                ...
                <div style={{fontSize:'12px',color:'#888',marginBottom:'8px'}}>{c.city} · {c.property_type} · {c.unit_count} units</div>
              ...
              <div style={{textAlign:'right',flexShrink:0,marginLeft:'16px'}}>
                <div style={{fontSize:'15px',fontWeight:'500',color:'#1a1a1a'}}>${c.monthly_fee_min}–${c.monthly_fee_max}/mo</div>
                <div style={{fontSize:'11px',color:'#888'}}>Confidence {c.confidence_score}%</div>
