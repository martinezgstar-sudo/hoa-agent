  ...
  <div style={{display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', flexWrap: 'wrap', gap: '12px'}}>
            <div>
              ...
              <div style={{display: 'flex', gap: '6px', flexWrap: 'wrap'}}>
                ...
                <span style={{fontSize: '11px', padding: '3px 8px', borderRadius: '4px', backgroundColor: '#E1F5EE', color: '#1B2B6B'}}>{community.entity_status || 'Active'} entity</san>
        ...
        <div style={{backgroundColor: '#fff', border: '1px solid #e5e5e5', borderRadius: '12px', padding: '20px 24px', marginBottom: '12px'}}>
          ...
          <div style={{display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '16px', marginBottom: '14px'}}>
            <div>
              ...
              <div style={{fontSize1px', color: '#888', marginTop: '2px'}}>Observed range</div>
            </div>
            <div>
        ...
        {community.assessment_signal_count > 0 && (
          <div style={{backgroundColor: '#fff', border:  solid #EF9F27', borderRadius: '12px', padding: '20px 24px', marginBottom: '12px'}}>
            <div style={{display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '14px'}}>
        ...
        <div style={{backgroundColor: '#1B2B6B', borderRadius: '12px', padding: '20px 24px', marginBottom: '12px'}}>
          <div style={{fontSize: '15px', fontWeight: '500', color: '#fff', marginBottom: '6px'}}>
            Do you  in {community.canonical_name}?
          </div>
            ...
            <div style={{display:'flex',flexDirection:'column',gap:'14px'}}>
              {comments.map((c) => (
                <div key={c.id} style={{borderBottom:'1px solid #f0f0f0',paddingBottom:'14px'}}>
                  ...
                  <div style={{fontSize:'13px',color:'#555',lineHeight:'1.6'}}>{c.comment_te/div>
                </div>
              ))}
            </div>
          </div>
        ...
        <div style={{backgroundColor: '#fff', border: '1px solid #e5e5e5', borderRadius: '12px', padding: '20px 24px', marginBottom: '12px', position: 'relative', overflow: 'hidden'}}>
          ...
          <div style={{position: 'absolute', top: 0, right: 0, bottom: 0, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', ndColor: 'rgba(255,255,255,0.85)', borderRadius: '12px'}}>
      ...
      {relatedCommunities && relatedCommunities.length > 0 && (
        <div style={{maxWidth:'720px',margin:'0 auto',padding:'0 32px 32px'}}>
          ...
          <div style={{display:'grid',gridTemplateColumns:'repeat(2,1fr)',gap:'10px',mainBottom:'12px'}}>
      ...
      <footer style={{borTop: '1px solid #e5e5e5', padding: '24px 32px', textAlign: 'center', fontSize: '12px', color: '#888', marginTop: '20px'}}>
