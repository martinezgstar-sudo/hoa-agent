...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const description = community.canonical_name + ' is a ' + (comty.property_type || 'residential') + ' community in ' + community.city + ', FL. ' + feeStr + ' View fees, assessments, restrictions and management company details.'
  ...
  return (
    <main style={{fontFamily: 'system-ui, sans-serif', margin: 0, padding: 0, backgroundColor: '#f9f9f9'}}>
      ...
      <div style={{maxWidth: '720px', margin: '0 auto', padding: '24px 32px'}}>
        ...
        <div style={{fontSize: '12px', color: '#8', marginBottom: '16px'}}>
          ...
          <div style={{display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', flexWrap: 'wrap', gap: '12px'}}>
            <div>
              ...
              <div style={{fontSize: '13px', color: '#888', marginBottom: '12px'}}>
                {community.city}, FL{coy.zip_code ? ' ' + community.zip_code : ''} · {community.county} County
              </div>
            ...
            {[
              ...
              return (
                <div key={r.label} style={{display: 'flex', justifyContent: 'space-between', alignItems: 'center', backgroundColor: '#f9f9f9', borderRadius: '8px', padding: '10px 12px', gap: '8px'}}>
                  ...
                  {isUnknown && (
                    <a href={'#' + commentFormId} style={{fontSize: '11px', color: '#1D9E75', border: '1px solid #1D9E borderRadius: '20px', padding: '2px 9px', textDecoration: 'none', whiteSpace: 'nowrap', flexShrink: 0}}>+ Add</a>
                  )}
                </div>
              )
            })}
        ...
        <div style={{backgroundColor: '#fff', border: '1px solid #e5e5e5', borderRadius: '12px', padding: '20px 24px', marginBottom: '12px', position: 'relative', overflow: 'hidden'}}>
          ...
          <div style={{position: 'absolute', top: 0, right: 0, bottom: 0, display: 'flex', flexDirection: 'column', alignItems: ' justifyContent: 'center', backgroundColor: 'rgba(255,255,255,0.85)', borderRadius: '12px'}}>
