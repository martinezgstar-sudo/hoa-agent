  ...
  return (
    <main style={{fontFamily:'system-ui,sans-serif',backgroundColor:'#f9f9f9',minHeight:'100vh'}}>
      ...
      <footer style={{borderTop:'1px solid #e5e5e5',padding:'24px 32px',textAlign:'center',fontSize:'12px',color:'#888',marginTop:'48px'}}>
        ...
        <div style={{marginTop:'8px',fontSize:'11px',color:'#aaa'}}><a href='/terms' style={{color:'#aaa',textDecoration:'none',marginRight:'16px'}}>Terms of Servicea href='/privacy' style={{color:'#aaa',textDecoration:'none'}}>Privacy Policy</a></div>
      </footer>
    </main>
  )
}
