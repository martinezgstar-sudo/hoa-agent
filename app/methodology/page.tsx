...
const DESC = "How HOA Agent sources community data and verifies fees. Full transparency on data sources and processing."
  ...
  return (
    ...
    >
      ...
      <ol>
        ...
        <li><strong>Tier 2 — Government APIs:</strong> additional public records sources.</li>
