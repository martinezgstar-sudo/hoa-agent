...
export const metadata: Metadata = {
  ...
  description: 'Real estate agents use HOA Agent to research HOA fees, assessments, and restrictions before showing listings in Palm Beach County.',
  openGraph: {
    title: 'For Real Estate Agents | HOA Agent',
    description: 'Due diligence for every Palm Beach County listing. HOA fees, special assessments, and restrictions — all in one free tool.',
...
const USE_CASES = [
  ...
  },
  {
    ...
    body: 'Walk your buyer through the community\'s fee history, management company, and restriction details. Surprises after the offer are how deals fall through — surface them during the walk-through instead.',
  },
  {
...
const DATA_POINTS = [
  ...
  { label: 'Special assessment signals', desc: 'From resident submissions and public records' },
    ...
    <main style={{ fontFamily: 'system-ui, sans-serif', backgroundColor: '#f9f9f9', minHeight: '100vh' }}>
      ...
      <div style={{ maxWidth: '760px', margin: '0 auto', padding: '52px 24px 80px' }}>
        ...
        <p style={{ fontSize: '16px', color: '#555', lineHeight: 1.8, marginBottom: '48px', maxWidth: '600px' }}>
          ...
          HOA Agent gives you instant access to fee ranges, restriction details, and management
          contacts — free, no account required.
        </p>
