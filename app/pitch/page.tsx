  ...
  return (
    <main style={{fontFamily:"system-ui,sans-serif",backgroundColor:"#0f1623",minHeight:"100vh",color:"#fff"}}>
      ...
      <section style={{padding:"80px 48px 64px",maxWidth:"900px",margin:"0 auto",textAlign:"center"}}>
        <div style={{fontSize:"11px",fontWeight:"600",color:"#1D9E75",textTransform:"uppercase",letterSpacing:"0.15em",mamarginBottom:"20px"}}>Florida HOA Intelligence Platform</div>
        <h1 style={{fontSize:"px",fontWeight:"700",lineHeight:"1.1",mamarginBottom:"24px",color:"#fff"}}>The missing data layer for Florida real estate</h1>
      ...
      <section style={{padding:"64px 48px",maxWidth:"900px",margin:"0 auto",borderTop:"1px solid rgba(255,255,255,0.08)"}}>
        <div style={{fontSize:"11px",fontWeight:"600",color:"#1D9E75",textTransform:"uppercase",letterSpacing:"0.15em",mamarginBottom:"16px"}}>The Problem</div>
        <h2 style={{fontSize:"32px",fontWeight:"600",lineHeight:"1.2",mamarginBottom:"20px"}}>HOA data is broken</h2>
        <p style={{fontSize:"15px",color:"rgba(255,255,255,0.6)",lineHeight:"1.8",mamarginBottom:"16px"}}>HOA and condo fees are one of the largest hidden costs in real estate. For a $400,000 home, a $500/month HOA fee adds $6,000 per year in carrng costs — yet buyers have no reliable single source for this data.</p>
        <p style={{fontSize:"15px",color:"rgba(255,255,255,0.6)",lineHeight:"1.8"}}>It is buried in MLS PDFs, scattered across county records, and inconsistent across platforms. Zillow shows it sometimes. Realtor.com misses it often. Nobody owns it cleanly.</p>
        <div style={{display:"grid",gridTemplateColumns:"repeat(3,1fr)",gap:"16px",marginTop:"32px"}}>
          {[{stat:"73%",label:"of Florida homes are in an HOA or condo association"},{stat:"$400-800",label:"average monthly HOA fee in Palm Beach County"},{stat:"0",label:"reliable structured databases for Florida HOA data"}].map(s => (
            <div key={s.stat} style={{backgroundColor:"rgba(255,255,255,0.05)",border:"1px solid rgba(255,255,255,0.08)",borderRadius:"12px",padding:"20px 24px"}}>
              <div style={{fontSize:"32px",fontWeight:"700",color:"#1D9E75",mamarginBottom:"4px"}}>{s.stat}</div>
      ...
      <section style={{padding:"64px 48px",maxWidth:"900px",margin:"0 auto",borderTop:"1px solid rgba(255,255,255,0.08)"}}>
        <div style={{fontSize:"11px",fontWeight:"600",color:"#1D9E75",textTransform:"uppercase",letterSpacing:"0.15em",mamarginBottom:"16px"}}>What We Have Built</div>
        <h2 style={{fontSize:"32px",fontWeight:"600",lineHeight:"1.2",mamarginBottom:"32px"}}>A working product, live today</h2>
      ...
      <section style={{padding:"64px 48px",maxWidth:"900px",margin:"0 auto",borderTop:"1px solid rgba(255,255,255,0.08)"}}>
        <div style={{fontSize:"11px",fontWeight:"600",color:"#1D9E75",textTransform:"uppercase",letterSpacing:"0.15em",mamarginBottom:"16px"}}>Revenue Model</div>
        <h2 style={{fontSize:"32px",fontWeight:"600",lineHeight:"1.2",mamarginBottom:"40px"}}>Three clear monetization tiers</h2>
        <div style={{display:"grid",gridTemplateColumns:"repeat(3,1fr)",gap:"20px"}}>
          {[{price:"Free",label:"Basic Access",items:["Community profiles","Fee ranges","Entity status","Address search","Up to 10 reviews"]},{price:"$2.99",label:"Reviews Unlock",items:["All resident reviews","Per community","One-time purchase","Instant access","No subscription"]},{price:"$29",label:"Full Report",items:["Complete fee trend PDF","Full source trail","All assessment signals","Restriction detail","Management history"]}].map(t => (
            <div key={t.price} style={{backgroundColor:"rgba(255,255,255,0.04)",border:"1px solid rgba(255,255,255,0.08)",borderRadius:"12px",padding:"24px"}}>
              <div style={{fontSize:"32px",fontWeight:"700",color:"#1D9E75",mamarginBottom:"4px"}}>{t.price}</div>
              <div style={{fontSize:"13px",fontWeight:"600",color:"#fff",mamarginBottom:"16px"}}>{t.label}</div>
              {t.items.map(i => (
                <div key={i} style={{display:"flex",alignItems:"center",gap:"8px",fontSize:"13px",color:"rgba(255,255,255,0.5)",mamarginBottom:"8px"}}>
          ...
          {[{phase:"Phase 1",title:"Complete Palm Beach County",desc:"Automate data collection via Spark API MLS integration. Cover all 2,000 plus HOA communities in Palm Beach County."},{phase:"Phase 2",title:"South Florida Expansion",desc:"Expand to Broward and Miami-Dade counties. Target 10,000 plus communities. Launch B2B API for property management companies."},{phase:"Phase 3",title:"Statewide Florida",desc:"Full Florida coverage. Launch white label platform for brokerages. Data licensing with title companies and mortgage lenders."},{phase:"Phase 4",title:"National Expansion",desc:"Expand to HOA-dense states — Arizona, Texas, Nevada, California. Position as the definitive national HOA intelligence platform."}].map((p,i) => (
            <div key={p.phase} style={{display:"flex",gap:"24px",alignItems:"flex-start"}}>
              ...
              <div style={{backgroundColor:"rgba(255,255,255,0.04)",border:"1px solid rgba(255,255,255,0.08)",borderRadius:"12px",padding:"20px 24px",flex:1}}>
                <div style={{fontSize:"11px",fontWeight:"600",color:"#1D9E75",textTransform:"uppercase",letterSpacing:"0.1em",mamarginBottom:"6px"}}>{p.phase}</div>
      ...
      <section style={{padding:"64px 48px",maxWidth:"900px",margin:"0 auto",borderTop:"1px solid rgba(255,255,255,0.08)"}}>
        <div style={{fontSize:"11px",fontWeight:"600",color:"#1D9E75",textTransform:"uppercase",letterSpacing:"0.15em",mamarginBottom:"16px"}}>Exit Potential</div>
        <h2 style={{fontSize:"32px",fontWeight:"600",lineHeight:"1.2",mamarginBottom:"20px"}}>Built to grow, positioned to sell</h2>
        <p style={{fontSize:"15px",color:"rgba(255,255,255,0.6)",lineHeight:"1.8",mamarginBottom:"32px"}}>A clean, structured, source-attributed HOA database covering Florida is a strategic asset for any platform serving real estate professionals or consumers.</p>
        <div style={{display:"grid",gridTemplateColumns:"repeat(3,1fr)",gap:"16px",mamarginBottom:"32px"}}>
      ...
      <section style={{padding:"64px 48px",maxWidth:"900px",margin:"0 auto",borderTop:"1px solid rgba(255,255,255,0.08)"}}>
        <div style={{fontSize:"11px",fontWeight:"600",color:"#1D9E75",textTransform:"uppercase",letterSpacing:"0.15em",mamarginBottom:"16px"}}>The Opportunity</div>
        <h2 style={{fontSize:"32px",fontWeight:"600",lineHeight:"1.2",mamarginBottom:"20px"}}>What we are looking for</h2>
        <p style={{fontSize:"15px",color:"rgba(255,255,255,0.6)",lineHeight:"1.8",mamarginBottom:"32px"}}>We are seeking a tech-experienced partner who sees the vision. We bring domain expertise, MLS access, a working live product, and a clear path to monetization and scale.</p>
        <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:"20px",mamarginBottom:"40px"}}>
          <div style={{backgroundColor:"rgba(255,255,255,0.04)",border:"1px solid rgba(255,255,255,0.08)",borderRadius:"12px",padding:"24px"}}>
            <div style={{fontSize:"14px",fontWeight:"600",color:"#1D9E75",mamarginBottom:"12px"}}>What we bring</div>
            {["Licensed Florida realtor with MLS access","Working live product at hoa-agent.com","Deep HOA and real estate market knowledge","Clear monetization model","Established legal and data foundation"].map(i => (
              <div key={i} style={{display:"flex",alignItems:"center",gap:"8px",fontSize:"13px",color:"rgba(255,255,255,0.6)",mamarginBottom:"8px"}}>
                <div style={{width:"4px",height:"4px",borderRadius:"50%",backgroundColor:"#1D9E75",flexShrink:0}}></div>
                {i}
              </div>
            ))}
          ...
          <div style={{backgroundColor:"rgba(255,255,255,0.04)",border:"1px solid rgba(255,255,255,0.08)",borderRadius:"12px",padding:"24px"}}>
            <div style={{fontSize:"14px",fontWeight:"600",color:"#1D9E75",mamarginBottom:"12px"}}>What we are looking for</div>
      ...
      <section style={{padding:"64px 48px 80px",maxWidth:"900px",margin:"0 auto",textAlign:"center",borderTop:"1px solid rgba(255,255,255,0.08)"}}>
        <h2 style={{fontSize:"36px",fontWeight:"700",mamarginBottom:"16px"}}>Let us build this together</h2>
        <p style={{fontSize:"16px",color:"rgba(255,255,255,0.5)",mamarginBottom:"32px"}}>Reach out to start a conversation.</p>
