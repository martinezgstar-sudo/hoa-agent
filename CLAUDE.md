...
## Current Stats (verified live 2026-05-20)
- 8,007 published communities in Palm Beach County
  (status counts: 8,007 published · 270 removed · 7 needs_review ·
   9 duplicate · 0 draft. Drift since May 5 snapshot: -19 published
   net, +13 removed, +9 duplicate — reflects additional commercial/
   dedupe sweeps.)
- 171 confirmed 55+ communities · 854 confirmed gated · 11 both
  (live as of 2026-05-20; minor drift from May 3 sweep counts)
- Coverage: Palm Beach County only (expanding to
  Broward and Miami-Dade in 2026)
- Admin dashboard: https://www.hoa-agent.com/admin

## Data Completeness Baseline (verified live 2026-05-20)
Live percentages over published rows (n=8,007). Replaces May 5 snapshot
which is preserved at logs/snapshots/CLAUDE.md.before-refresh-2026-05-20:
- ZIP code:           99.25%  (was 98.9%)
- Unit count:         60.98%  (was 60.7%)
- Entity status:      33.67%  (was 34.1%)
- Street address:     29.30%  (was 29.2%)
- Registered agent:    7.01%  (was 5.1% — backfill landed)
- Management company:  4.85%  (was 5.0%)
- Amenities:           1.60%  (was 1.6%)
- Monthly fees:        1.32%  (was 1.3%)
- Website URL:         0.59%  (was 0.6%)
...
Current counts (live 2026-05-20):
- Confirmed 55+: 171 (was 173 post May 3 sweep — 2 rows removed/dedup'd)
- Confirmed gated: 854 (was 855)
- Both 55+ and gated: 11 (was 10)
- is_age_restricted: tracks is_55_plus
...
Production columns (use these): master_hoa_id (uuid → master id),
is_sub_hoa (boolean). A master is identified by other rows pointing
to it via master_hoa_id, not by a flag on itself.
Aspirational columns NOT in production: is_master, parent_id (do not query).

Confirmed Palm Beach County masters — live sub-counts as of 2026-05-20
(queried via communities.master_hoa_id with status='published'):
- Abacoa Property Owners' Assembly, Inc. (43 subs)
- PGA National (40 subs)
- Mirasol Property Owners Association, Inc. (30 subs)
- Boca West Master Association, Inc. (29 subs)
- The Club At Ibis Property Owners' Association, Inc. (27 subs)
- Jonathan's Landing Property Owners Association (17 subs)
- Golden Lakes Village Association, Inc. (13 subs)
- River Bridge Property Owners' Association, Inc. (13 subs)
- Villages Of Palm Beach Lakes Property Owners' Association, Inc. (12 subs)
- The Polo Club Of Boca Raton Property Owners Association, Inc. (11 subs)
- Breakers West Master Association (10 subs)
- Indian Spring Village Homeowners' Association, Inc. (7 subs)
- Woodbine Master Association, Inc. (7 subs)
- Evergrene Master Association, Inc. (6 subs)
- Baywinds Community Association, Inc. (5 subs)
- Ballenisles Community Association, Inc. (2 subs)
- Olympia Master Association, Inc. (1 sub — note: down from earlier
  "17 village subs" estimate; village links need a re-link sweep)
- Seven Bridges (0 subs — single HOA)
- The Acreage — NO master HOA, ITID governs

Drift note: Sub-counts here are materially higher than the May 5
estimates (PGA 17→40, Abacoa 15→43, Mirasol 7→30, Ibis 9→27, Evergrene
2→6) because additional master_hoa_id links landed during May
backfills. Olympia is the lone regression — village links appear to
have been unlinked or never connected to the master row; flag for
admin review per rule #17 (never auto-unlink).
